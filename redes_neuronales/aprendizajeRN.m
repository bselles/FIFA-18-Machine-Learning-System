function porcentajeAcierto=aprendizajeRN(lambda)
  warning('off','all');
  num_entradas=15;          #Número de atributos de entrada.
  num_ocultas=1000;
  num_etiquetas=14;         #Número de clases entre las que clasificará los ejemplos de entrenamiento.
  
  X=load('../datasets/X.csv');
  
  #Realizamos el arreglo, eliminando los ejemplos de entrenamiento con valores problematicos.
